...
fullmagmatable <- read_csv(here("ProcessedData", "fullTableMetaMagma.csv"))
fullmagmatablerank <-read_csv(here("ProcessedData", "fullTableMetaMagmaRank.csv"))
fullmagmatablerank %<>% rename(meta_p = genome_percentile_rank_p)
SIfullmagmatable <-read_csv(here("ProcessedData", "SIFullTableMetaMagma.csv"))
SIfullmagmatablerank <-read_csv(here("ProcessedData", "SIFullTableMetaMagmaRank.csv"))
SIfullmagmatablerank %<>% rename(meta_p = genome_percentile_rank_p)
feamlemagmatable <-read_csv(here("ProcessedData", "femaleTableMetaMagma.csv"))
femalemagmatablerank <-read_csv(here("ProcessedData", "femaleTableMetaMagmaRank.csv"))
femalemagmatablerank %<>% rename(meta_p = genome_percentile_rank_p)
malemagmatable <-read_csv(here("ProcessedData", "maleTableMetaMagma.csv"))
malemagmatablerank <-read_csv(here("ProcessedData", "maleTableMetaMagmaRank.csv"))
malemagmatablerank %<>% rename(meta_p = genome_percentile_rank_p)
corticalmagmatable <-read_csv(here("ProcessedData", "corticalTableMetaMagma.csv"))
corticalmagmatablerank <-read_csv(here("ProcessedData", "corticalTableMetaMagmaRank.csv"))
corticalmagmatablerank %<>% rename(meta_p = genome_percentile_rank_p)
SIcorticalmagmatable <-read_csv(here("ProcessedData", "SICorticalTableMetaMagma.csv"))
SIcorticalmagmatablerank <-read_csv(here("ProcessedData", "SICorticalTableMetaMagmaRank.csv"))
SIcorticalmagmatablerank %<>% rename(meta_p = genome_percentile_rank_p)
